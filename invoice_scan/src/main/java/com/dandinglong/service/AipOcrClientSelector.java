...
public class AipOcrClientSelector {
    ...
    public synchronized void init(){
        ...
        while (iterator.hasNext()){
            ...
            MyAipOcr aipOcr=new MyAipOcr(next.getAppId(),next.getAppKey(),next.getSecretKey());
            aipOcr.getToken();
    ...
    public MyAipOcr getAvailableInvoiceClient(int aipClientListIndex){
