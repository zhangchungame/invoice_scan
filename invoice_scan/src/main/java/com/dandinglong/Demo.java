...
public class Demo {
    ...
    public void testMyAip(){
        MyAipOcr aipOcr = new MyAipOcr("17864821", "PmQ2gx4KovbDekph57GbscFd", "GqwAUKGguPiQFxFA2T8tx8GrjzbyYUw6");
        String token = aipOcr.getToken();
        MyAipOcr myAipOcr = new MyAipOcr("", "", "");
        myAipOcr.setToken(token);
        org.json.JSONObject jsonObject = myAipOcr.vatInvoice("f:/img.jpg", null);
