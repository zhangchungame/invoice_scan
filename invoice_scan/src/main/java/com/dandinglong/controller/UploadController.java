...
public class UploadController extends BaseController{
    ...
    @RequestMapping("/upload/failReUpload")
    public JsonResult failReUpload(@RequestParam(value = "imageUrl")String imageUrl,@RequestParam(value = "uploadId")int uploadId){
        UserEntity userEntity=getUserEntity();
        return ResultUtil.success(uploadService.reUpload(imageUrl,uploadId,userEntity.getId()));
    }
}
